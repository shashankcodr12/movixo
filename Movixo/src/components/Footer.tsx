    ...
    <footer className="bg-[#0f0f1a] border-t border-white/10 mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              India&apos;s largest entertainment ticketing platform. Book tickets for movies, events, sports, and more.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Now Showing', 'Upcoming', 'Top Rated', 'New Releases', 'Languages'].map((item) => (
                <li key={item}>
                  <Link to="/" className="text-gray-400 hover:text-white text-sm transition-colors">{item}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['About Us', 'Contact Us', 'FAQs', 'Terms of Service', 'Privacy Policy', 'Cancellation Policy'].map((item) => (
                <li key={item}>
                  <Link to="/" className="text-gray-400 hover:text-white text-sm transition-colors">{item}</Link>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">Get the best experience on our mobile app</p>
        ...
        <div className="border-t border-white/10 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">© 2025 BookMyShow. All rights reserved.</p>
