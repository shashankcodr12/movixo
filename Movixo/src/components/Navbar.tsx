...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { label: 'Stream', icon: Ticket, path: '/stream' },
    { label: 'Events', icon: Music, path: '/events' },
    { label: 'Sports', icon: Gamepad2, path: '/sports' },
          ...
          <div className="flex-1 max-w-md hidden md:block">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white/10 text-white placeholder-gray-400 pl-10 pr-4 py-2 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#e63946] focus:bg-white/15 transition-all"
              />
            </div>
          </div>
                ...
                <AnimatePresence>
                  {showUserMenu && (
                    <motion.div
                      ...
                      className="absolute right-0 top-full mt-1 w-48 bg-[#1a1a2e] border border-white/10 rounded-xl shadow-2xl overflow-hidden z-50"
                    >
                      <Link to="/profile" className="block px-4 py-2.5 text-sm text-gray-300 hover:bg-white/10 hover:text-white transition-colors">My Profile</Link>
                      <Link to="/bookings" className="block px-4 py-2.5 text-sm text-gray-300 hover:bg-white/10 hover:text-white transition-colors">My Bookings</Link>
